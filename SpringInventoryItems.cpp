...
ASpringInventoryItems::ASpringInventoryItems() {
	...
	ItemIcon = Cast<UTexture2D>(StaticLoadObject(UTexture2D::StaticClass(), NULL, TEXT("/Script/Engine.Texture2D'/Game/Texture2D/Spring.Spring'")));
	NumItemInOne = 4;
