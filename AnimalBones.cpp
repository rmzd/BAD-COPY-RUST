...
AAnimalBones::AAnimalBones() {
	...
	ItemIcon = Cast<UTexture2D>(StaticLoadObject(UTexture2D::StaticClass(), NULL, TEXT("/ Script / Engine.Texture2D'/Game/Texture2D/Bone_Fragments_icon.Bone_Fragments_icon'")));
